...
export const PAYMENT_VERIFICATION_SUCCESS =
  "PAYMENT_VERIFICATION_SUCCESS";
export const PAYMENT_VERIFICATION_FAILURE =
...
export const UPLOAD_SCHOOL_PROFILE_SUCCESS =
  "UPLOAD_SCHOOL_PROFILE_SUCCESS";
export const UPLOAD_SCHOOL_PROFILE_FAILURE =
  "UPLOAD_SCHOOL_PROFILE_FAILURE";

export const UPDATE_CLASS_NAME_SUCCESS =
  "UPDATE_CLASS_NAME_SUCCESS";
export const UPDATE_CLASS_NAME_FAILURE =
  "UPDATE_CLASS_NAME_FAILURE";

export const UPLOAD_SCHOOL_LOGO_SUCCESS =
  "UPLOAD_SCHOOL_LOGO_SUCCESS";
export const UPLOAD_SCHOOL_LOGO_FAILURE =
...
export const GET_CLASS_MEMBERS_SUCCESS =
  "GET_CLASS_MEMBERS_SUCCESS";
export const GET_CLASS_MEMBERS_FAILURE =
  "GET_CLASS_MEMBERS_FAILURE";

export const GET_CLASS_SUBJECTS_SUCCESS =
  "GET_CLASS_SUBJECTS_SUCCESS";
export const GET_CLASS_SUBJECTS_FAILURE =
...
export const GET_PEOPLE_IN_PAYMENT_CLASS_SUCCESS = 'GET_PEOPLE_IN_PAYMENT_CLASS_SUCCESS';
export const GET_PEOPLE_IN_PAYMENT_CLASS_FAILURE = 'GET_PEOPLE_IN_PAYMENT_CLASS_FAILURE';

// user dashboard
export const GET_USER_DASHBOARD_ENROLLED_COURSE_SUCCESS = 'GET_USER_DASHBOARD_ENROLLED_COURSE_SUCCESS';
export const GET_USER_DASHBOARD_ENROLLED_COURSE_FAILURE = 'GET_USER_DASHBOARD_ENROLLED_COURSE_FAILURE';
export const GET_USER_DASHBOARD_CLASS_MEMBERSHIP_SUCCESS = 'GET_USER_DASHBOARD_CLASS_MEMBERSHIP_SUCCESS';
export const GET_USER_DASHBOARD_CLASS_MEMBERSHIP_FAILURE = 'GET_USER_DASHBOARD_CLASS_MEMBERSHIP_FAILURE';
export const GET_USER_DASHBOARD_RECENT_ACTIVITIES_SUCCESS = 'GET_USER_DASHBOARD_RECENT_ACTIVITIES_SUCCESS';
export const GET_USER_DASHBOARD_RECENT_ACTIVITIES_FAILURE = 'GET_USER_DASHBOARD_RECENT_ACTIVITIES_FAILURE';
export const GET_USER_DASHBOARD_RECOMMENDATIONS_SUCCESS = 'GET_USER_DASHBOARD_RECOMMENDATIONS_SUCCESS';
export const GET_USER_DASHBOARD_RECOMMENDATIONS_FAILURE = 'GET_USER_DASHBOARD_RECOMMENDATIONS_FAILURE';
export const GET_USER_DASHBOARD_PERFORMANCE_SUMMARY_SUCCESS = 'GET_USER_DASHBOARD_PERFORMANCE_SUMMARY_SUCCESS';
export const GET_USER_DASHBOARD_PERFORMANCE_SUMMARY_FAILURE = 'GET_USER_DASHBOARD_PERFORMANCE_SUMMARY_FAILURE';

// performance analysis
export const GET_SUBJECT_PROGRESS_PERFORMANCE_SUCCESS = 'GET_SUBJECT_PROGRESS_PERFORMANCE_SUCCESS';
export const GET_SUBJECT_PROGRESS_PERFORMANCE_FAILURE = 'GET_SUBJECT_PROGRESS_PERFORMANCE_FAILURE';
export const GET_SUBJECT_QUIZ_PERFORMANCE_SUCCESS = 'GET_SUBJECT_QUIZ_PERFORMANCE_SUCCESS';
export const GET_SUBJECT_QUIZ_PERFORMANCE_FAILURE = 'GET_SUBJECT_QUIZ_PERFORMANCE_FAILURE';
export const GET_SUBJECT_PAST_QUESTIONS_PERFORMANCE_SUCCESS = 'GET_SUBJECT_PAST_QUESTIONS_PERFORMANCE_SUCCESS';
export const GET_SUBJECT_PAST_QUESTIONS_PERFORMANCE_FAILURE = 'GET_SUBJECT_PAST_QUESTIONS_PERFORMANCE_FAILURE';