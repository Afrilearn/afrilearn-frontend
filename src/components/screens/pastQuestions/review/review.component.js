...
const Review = (props) => {
  ...
  useEffect(() => {
    if (!mounted.current) {
      ...
      if (nextLessonLocation) {
        props.inputChange("pastQuestionRedirectLocation", nextLessonLocation);
      } else {
        props.inputChange("pastQuestionRedirectLocation", "/dashboard");
      }
      props.submitUserScore(
        handleGrade(false, true),
        Math.round((correctAnswers / questionLength) * 100)
      );
    } else {
      ...
      return questionTags.map((item, index) => {
        return (
          <div className="col-md-3">
            <Link onClick={handleRenavigation.bind(this, index)}>
              <span
                className={`status ${
                  answers[index] == "-1"
                    ? "skipped"
                    : questions[index].correct_option == answers[index]
                    ? "attempted"
                    : "incorrect"
                }`}
              >
  ...
  return (
    <>
      {pastQuestionRedirect ? (
        <Redirect to={pastQuestionRedirectLocation} />
      ) : null}
      <div className="container-fluid Review">
        <div className="row">
          <div className="col-md-9 partOne">
            <div className="row">
              <div className="col-12 nameSection">Hey {fullName},</div>
            </div>
            <div className="row comment">
              <div className="col-2">{handleGrade(true)}</div>
            ...
            <div className="row p4 mobileOnly">
              <div className="col-12 center">
                <span className="headingOne timerTitle">
                  Score: <sup>{correctAnswers}</sup>/<sub>{questionLength}</sub>
                </span>{" "}
                <br />
                <span>
                  Pass Rate:{" "}
          ...
          <div className="col-md-3 timerSection desktopOnly">
            <div className="row nameSection">
              ...
              <div className="col-4 summary">Key Stats</div>
            </div>
            <div className="row comment1">
              <div className="col-4">
                <div className="row">
                  <div className="col-6">
                    <img
                      src={require("../../../../assets/img/Score Rank.svg")}
                      alt="logo"
                      className="myBadge1"
                    />
                  </div>
                  <div className="col-6 paddingAdjust">
                    <span className="boldFont">Score</span>
                    <br /> <sup>{correctAnswers}</sup>/
                    <sub>{questionLength}</sub>
                  </div>
                </div>
              </div>
              <div className="col-4">
                <div className="row">
                  <div className="col-6">
                    <img
                      src={require("../../../../assets/img/Accuracy.svg")}
                      alt="logo"
                      className="myBadge1"
                    />
                  </div>
                  <div className="col-6 paddingAdjust">
                    <span className="boldFont">Accuracy</span> <br />
                    {Math.round((correctAnswers / questionLength) * 100)}%
                  </div>
                </div>
              </div>
              <div className="col-4">
                <div className="row">
                  <div className="col-6">
                    <img
                      src={require("../../../../assets/img/Velocity.svg")}
                      alt="logo"
                      className="myBadge1"
                    />
                  </div>
                  <div className="col-6 paddingAdjust">
                    <span className="boldFont">Velocity</span>
                    <br />
                    {speed}
                  </div>
                </div>
            ...
            <div className="row push3">
              <div className="col-4">
                <div className="row">
                  ...
                  <div className="col-12 boxUp">
                    <img
                      src={require("../../../../assets/img/Correct Box.svg")}
                      alt="logo"
                      className="myBadge2"
                    />{" "}
                    {correctAnswers}
              ...
              <div className="col-4">
                <div className="row">
                  ...
                  <div className="col-12 boxUp">
                    <img
                      src={require("../../../../assets/img/Incorrect Box.svg")}
                      alt="logo"
                      className="myBadge2"
                    />{" "}
                    {questionLength -
                      (correctAnswers +
                        questionTags.filter((el) => el === 3).length)}
                  </div>
                </div>
              </div>
              <div className="col-4">
                <div className="row">
                  ...
                  <div className="col-12 boxUp">
                    <img
                      src={require("../../../../assets/img/Skipped Box.svg")}
                      alt="logo"
                      className="myBadge2"
                    />{" "}
                    {questionTags.filter((el) => el === 3).length}
            ...
            <div className="row checkUps center">{questionTagsList()}</div>
          </div>
        </div>
      </div>
      <Modal isOpen={modal} toggle={toggle} className="reportModalClass">
        <ModalHeader toggle={toggle} className="report">
          Report An Issue
        </ModalHeader>
        <ModalBody>
