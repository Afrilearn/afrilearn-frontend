                                        ...
                                        <div className="col-8 paddingRightOff">                                          
                                            <ul>
                                                <li className="relative myDrop">
                                                    <Link className="myPlaceholder">Select a Class
                                                    <img className="downArrow" src={require('../../../assets/img/downarrow.png')} alt="down arrow"/> 
                                                    </Link>
                                                    <ul className="courseSelectSectionDropDown">
                                                        <li><Link>Primary One</Link></li>
                                                        <li><Link>Primary Two</Link></li>
                                                        <li><Link>Primary Three</Link></li>
                                                        <li><Link>Primary Four</Link></li>
                                                        <li><Link>Primary Five</Link></li>
                                                        <li><Link>Primary Six</Link></li>
                                                        <li><Link>JSS One</Link></li>
                                                        <li><Link>JSS Two</Link></li>
                                                        <li><Link>JSS Three</Link></li>
                                                        <li><Link>SSS One</Link></li>
                                                        <li><Link>SSS Two</Link></li>
                                                        <li><Link>SSS Three</Link></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>                                        
            ...
            {/* <Particles/>              */}
                ...
                <div className="row students">
                    <div className="col-md-8">
                        <h1>Students love using<br className="desktopOnly"/> Afrilearn</h1>
                    ...
                    <div className="col-md-4">
                        <div className="row push">
                            <div className="col-4">
                                <img className="iconSet" src={require('../../../assets/img/video.png')} alt="video lessons"/> 
                            </div>
                            <div className="col-8">
                                <h2>178,345,948</h2>
                                <h5>Video Lessons</h5>
                        ...
                        <div className="row push">
                            <div className="col-4">
                                <img className="iconSet" src={require('../../../assets/img/questions.png')} alt="questions"/> 
                            </div>
                            <div className="col-8">
                                <h2>120,984,030</h2>
                        ...
                        <div className="row push">
                            <div className="col-4">
                                <img className="iconSet" src={require('../../../assets/img/topics.png')} alt="topics"/> 
                            </div>
                            <div className="col-8">
                                <h2>104,384,231</h2>
                                <h5>Topic Quizzes</h5>
                ...
                <div className="row mobile">
                    <div className="col-md-6 partOne">                  
                        ...
                        <div className="row push2">
                            <div className="col-6">
                                <img className="" src={require('../../../assets/img/playstore.png')} alt="playstore"/> 
                            </div>
                            <div className="col-6">
                                <img className="" src={require('../../../assets/img/applestore.png')} alt="applestore"/> 
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                ...
                <div className="row">
                    <div className="col-md-3"></div>
                    <div className="col-md-6">
                       <h6 className="center">Interested? Enter your email and we’ll keep you in the loop!</h6>
                       <div className="row">
                            <div className="col-8 paddingRightOff">
