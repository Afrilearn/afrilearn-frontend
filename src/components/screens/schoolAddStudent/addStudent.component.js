...
const SchoolAddTeacherToClass = props => {
  ...
  const handleSubmit = e => {
    ...
    if (message) {
      ...
      Swal.fire({
        html: `<div>Student ${fullName} registered successfully</div>`,
        icon: 'success',
        showClass: {
          popup: 'animate__animated animate__fadeInDown'
        },
  ...
  return (
    <span id='school-add-student'>
      ...
      <div id='school-add-student-first-section'></div>
              ...
              <form onSubmit={handleSubmit}>
                <div className='col-md-12'>
                  ...
                  >
                    ...
                    unlimited access to curriculum relevant classnotes and video lessons
                  </div>
                </div>
                <div className='col-md-12'>
                  <select
