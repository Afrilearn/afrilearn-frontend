...
const ClassroomTeacher = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      populateDashboardTopTenVideos(activeEnrolledCourseId ? data1 : null)
    );
    dispatch(
      populateDashboardFavouriteVideos(activeEnrolledCourseId ? data : null)
    );
          ...
          <TabPane tabId="1">
            <div className="content-section">
              <div id="classes" className="container-fluid relative subjects">
                ...
                <a name="topTen"></a>
                <h4 className="push5 resumePlayingBox topT">
                  Top Ten Lessons{" "}
                ...
                <a name="favourite"></a>
                <h4 className="push5 resumePlayingBox favT">
                  My Fav{" "}
                  <small className="showAll">
